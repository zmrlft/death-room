...
export class SpikesStateMachine extends StateMachine {
  ...
  initAnimationEvent() {
    this.animationComponent.on(Animation.EventType.FINISHED, () => {
      ...
      if (
        (value === ENTITY_TYPE_ENUM.SPIKES_ONE && name.includes('spikesone/two')) ||
        (value === ENTITY_TYPE_ENUM.SPIKES_TWO && name.includes('spikestwo/three')) ||
        (value === ENTITY_TYPE_ENUM.SPIKES_THREE && name.includes('spikesthree/four')) ||
        (value === ENTITY_TYPE_ENUM.SPIKES_FOUR && name.includes('spikesfour/five'))
      ) {
